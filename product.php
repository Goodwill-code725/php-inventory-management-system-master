	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Add Product</div>
			</div> <!-- /panel-heading -->
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-default button1" data-toggle="modal" id="addProductModalBtn" data-target="#addProductModal"> <i class="glyphicon glyphicon-plus-sign">
					</i> Add Product </button>
				</div> <!-- /div-action -->				
				
				<table class="table" id="manageProductTable">
					<thead><!-- update this with actual ingredients table -->
						<tr>
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
			...
			<!-- Add Product Modal: New Section for Ingredients -->
					<div class="form-group" id="ingredientsSection">
							<label for="ingredients" class="col-sm-3 control-label">Ingredients:</label>
							<label class="col-sm-1 control-label"> :</label>
							<div class="col-sm-8">
								<div id="ingredientFields">
									<!-- Dynamic Ingredient Fields will go here -->
					</div>
						<button type="button" id="addIngredientBtn" class="btn btn-default">
							Add Ingredient
						</button>
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
			        ...
			        <div class="form-group">
			        	<label for="editBrandName" class="col-sm-3 control-label">Made By: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
...
<script>
    ...
    $('#addIngredientBtn').on('click', function () {
        ingredientCount++;
        var ingredientHTML = `
            <div class="ingredientField" id="ingredientField_${ingredientCount}">
                <div class="form-group">
                    <label for="ingredient_${ingredientCount}" class="col-sm-3 control-label">Ingredient ${ingredientCount}:</label>
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-8">
        ...
        `;
        $('#ingredientFields').append(ingredientHTML);
    });

    $(document).on('click', '.removeIngredientBtn', function () {
        var id = $(this).data('id');
        $('#ingredientField_' + id).remove();
    });
});
